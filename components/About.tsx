      ...
      before:absolute before:top-0 before:w-full before:h-[5rem] before:z-10 before:bg-gradient-to-b before:from-[#ECF0FA] before:to-[#F2F4F7]">
        <div className="w-full flex flex-col justify-around sm:w-[95vw] md:w-[90vw] pt-20 ">
            <div className="w-full h-[15rem] flex flex-col justify-evenly items-center mt-16 mb-14 md:flex-row px-2 py-4">
                <h2 className="text-xl md:text-[1.7rem] text-slate-800 font-['Switzer'] font-semibold">We are Proud to say that ,
            ...
            <div className="w-full p-2 mt-2 mb-11 flex flex-col sm:flex-row flex-wrap items-center justify-around">
                ...
                <div className=" sm:w-[25rem] sm:p-4 flex mt-4  sm:m-0 mb-4 h-[6rem] sm:h-[8rem] justify-around items-center shadow-lg sm:shadow-xl border border-slate-300 p-3 rounded-lg bg-[#f0f2f5]">
            ...
            <div className="w-full flex flex-col flex-wrap sm:flex-row sm:justify-evenly mb-11 sm:mt-[4rem] items-center min-h-[50vh] ">
                <div className="max-w-[22rem] sm:w-[25rem] h-[26.5rem] mt-11 sm:mt-4 sm:m-0 rounded-xl shadow-lg">
                    <div className="w-full h-[14rem]">
                        <img src="BeginnerCourse.jpg" className="w-full rounded-xl h-auto max-h-full" style={{objectFit:"cover"}} alt="" />
                    </div> 
                    <div className="h-[12.5rem] mt-4 px-4  w-full py-3 flex flex-col justify-around items-end ">
                ...
                <div className="max-w-[22rem] sm:w-[25rem] h-[26.5rem] mt-11 mb-12 sm:mt-4 sm:m-0 rounded-xl shadow-lg">
                    <div className="w-full h-[14rem]">
